...
namespace DMPS.Infrastructure.IO.Pdf.Exceptions;

/// <summary>
/// Represents errors that occur during the PDF generation process.
/// This exception serves as a wrapper for any exceptions thrown by the underlying PDF library.
/// </summary>
[Serializable]
public class PdfGenerationException : Exception
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="PdfGenerationException"/> class with serialized data.
    /// </summary>
